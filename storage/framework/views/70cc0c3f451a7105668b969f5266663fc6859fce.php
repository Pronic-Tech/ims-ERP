            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tfoot>
                    <tr style="font-size: 14px; background: orangered;color: white;">
                        ...
                        <td  class="text-right"><?php echo e($data['student']->sum('fee_amount'), false); ?></td>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/account/fees/balance/includes/table.blade.php ENDPATH**/ ?>