...
<?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="option_value">
        ...
        <td>
            <input type="hidden" name="staffs_id[]" value="<?php echo e($staff->id, false); ?>">
        ...
        <td>
            <?php $__currentLoopData = $attendanceStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="pos-rel">
                    <?php echo Form::radio($staff->id, $status->id, false, ['class' => 'ace status-'.$status->id,"required"]); ?>
    ...
    <?php ($i++); ?>
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/attendance/staff/includes/staff_tr.blade.php ENDPATH**/ ?>