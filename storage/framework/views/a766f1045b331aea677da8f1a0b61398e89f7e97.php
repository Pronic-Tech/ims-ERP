    ...
    <div class="col-xs-12">
        ...
        <div class="clearfix">
            <div>
                ...
                <div class="col-sm-2">
                    <?php echo Form::select('student_batch', $data['batch'], null, ['class' => 'form-control','id'=>'transfer-status' , "required"]); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/student/transfer/includes/table.blade.php ENDPATH**/ ?>