                ...
                <?php if(isset($data['schedule_exams']) && $data['schedule_exams']->count() > 0): ?>
                    ...
                    <?php $__currentLoopData = $data['schedule_exams']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-minier dropdown-toggle <?php echo e($exam->publish_status == '1'?"btn-info":"btn-warning", false); ?>" >
...
</div><?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/examination/schedule/includes/table.blade.php ENDPATH**/ ?>