...
<div class="form-group">
    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
        ...
        <tr class="option_value">
            ...
            <td width="40%">
                <?php echo Form::select('fee_head[]', $data['feeHead'], null, ['class' => 'form-control chosen-select feeHead', 'required','onChange' => 'setAmount(this);'], $data['fee_head_attributes']); ?>

            </td>
            <td width="25%">
                <?php echo Form::text('fee_amount[]', null, ["id" => $data['randId'], "class" => "col-xs-10 col-sm-11 feeAmount" , "required"]); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/account/fees/master/includes/add.blade.php ENDPATH**/ ?>