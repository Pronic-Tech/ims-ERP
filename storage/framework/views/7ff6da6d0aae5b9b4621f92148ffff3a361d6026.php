<div class="form-group">
    <?php echo Form::label('name', 'Name or Email', ['class' => 'col-sm-2 control-label']); ?>
    ...
    <?php echo Form::label('role', 'User Role', ['class' => 'col-sm-2 control-label']); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/user/includes/search_form.blade.php ENDPATH**/ ?>