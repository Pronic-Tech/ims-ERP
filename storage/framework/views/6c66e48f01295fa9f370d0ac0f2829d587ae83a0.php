...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?php echo Form::text('reg_date', null, ["class" => "form-control date-picker border-form input-mask-date","required"]); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?php echo Form::text('date_of_birth', null, ["class" => "form-control border-form date-picker input-mask-date","required"]); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?php echo Form::text('national_id_type', null, ["placeholder" => "", "class" => "form-control border-form upper"]); ?>
    ...
    <div class="col-sm-2">
        <?php echo Form::text('national_id_number', null, ["class" => "form-control border-form upper"]); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?php echo Form::text('extra_id_card_type', null, ["class" => "form-control border-form upper"]); ?>
    ...
    <div class="col-sm-2">
        <?php echo Form::text('extra_id_card_number', null, ["placeholder" => "", "class" => "form-control border-form upper"]); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/student/registration/includes/forms/generalinfo.blade.php ENDPATH**/ ?>