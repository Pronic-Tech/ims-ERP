    ...
    <div class="tab-content">
        <div id="header-script" class="tab-pane in active">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <?php echo Form::textarea('header_codes', null, ["placeholder" => "", "class" => "form-control border-form"]); ?>

                    <?php echo $__env->make('includes.form_fields_validation_message', ['name' => 'header_codes'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
        ...
        <div id="footer-script" class="tab-pane">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <?php echo Form::textarea('footer_codes', null, ["placeholder" => "", "class" => "form-control border-form"]); ?>

                    <?php echo $__env->make('includes.form_fields_validation_message', ['name' => 'footer_codes'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
        ...
        <div id="post-foot-script" class="tab-pane">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <?php echo Form::textarea('post_detail_foot', null, ["placeholder" => "", "class" => "form-control border-form"]); ?>

                    <?php echo $__env->make('includes.form_fields_validation_message', ['name' => 'post_detail_foot'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/web/admin/settings/general/includes/forms/headerfooter.blade.php ENDPATH**/ ?>