    ...
    <span class="easy-link-menu">
        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        <td class="text-center" colspan="16"><?php echo $data['user-activity']->appends($data['filter_query'])->links(); ?></td>
                    </tr>
                    <tr>
                        <th class="center">
                            <label class="pos-rel">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo e(route($base_route.'.delete', ['id' => $activity->id]), false); ?>" class="btn btn-danger btn-minier bootbox-confirm" >
...
</div><?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/super-suit/user-activity/includes/table.blade.php ENDPATH**/ ?>