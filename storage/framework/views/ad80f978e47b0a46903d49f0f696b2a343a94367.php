...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo Form::text('father_last_name', null, [ "class" => "form-control border-form upper"]); ?>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo Form::text('mother_last_name', null, [ "class" => "form-control border-form upper"]); ?>
...
<div id="guardian-detail">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <?php echo Form::text('guardian_last_name', null, [ "class" => "form-control border-form upper"]); ?>
...
<div id="link-guardian-detail">
    <div class="form-group">
        ...
        <div class="col-sm-12">
            <?php echo Form::select('guardian_link_id', [], null, ["placeholder" => "Type Student Reg.No. or Guardians Name...", "class" => "col-xs-12 col-sm-12", "style" => "width: 100%;"]); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/student/registration/includes/forms/parent.blade.php ENDPATH**/ ?>