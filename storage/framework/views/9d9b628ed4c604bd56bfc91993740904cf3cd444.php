...
<div class="form-group">
    <?php echo Form::label('student_main_image', 'Student Profile Picture', ['class' => 'col-sm-2 control-label']); ?>
...
<div class="form-group">
    <?php echo Form::label('student_signature_main_image', 'Student Signature', ['class' => 'col-sm-2 control-label']); ?>
...
<div class="form-group">
    <?php echo Form::label('father_main_image', 'Father Picture', ['class' => 'col-sm-2 control-label']); ?>
...
<div class="form-group">
    <?php echo Form::label('mother_main_image', 'Mother Picture', ['class' => 'col-sm-2 control-label']); ?>
...
<div class="form-group">
    <?php echo Form::label('guardian_main_image', 'Guardian Picture', ['class' => 'col-sm-2 control-label']); ?>
    ...
    <?php else: ?>
        <img id="" class="img-responsive" alt="Avatar" src="<?php echo e(asset('assets/images/avatars/profile-pic.jpg'), false); ?>" width="100px">
    <?php endif; ?>
</div><?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/student/registration/includes/forms/profileimage.blade.php ENDPATH**/ ?>