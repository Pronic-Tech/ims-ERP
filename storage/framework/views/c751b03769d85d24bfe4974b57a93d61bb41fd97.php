...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?php echo Form::select('years_id', $data['years'], null, ["class" => "form-control border-form","required", "onChange" => "loadSubject(this)"]); ?>
    ...
    <div class="col-sm-2">
        <?php echo Form::select('months_id', $data['months'], null, ["class" => "form-control border-form","required", "onChange" => "loadSubject(this)"]); ?>
    ...
    <div class="col-sm-5">
        <?php echo Form::select('exams_id', $data['exams'], null, ["class" => "form-control border-form chosen-select","onChange" =>"loadSubject(this)","required"]); ?>
...
<?php /**PATH C:\xampp7.4\htdocs\EduFirm\resources\views/examination/schedule/includes/form.blade.php ENDPATH**/ ?>